...
// TODO: remove
internal.copyRecord = copyRecord;
internal.getValueType = getValueType; // used by GUI
internal.fixInconsistentFields = fixInconsistentFields;
internal.fieldListContainsAll = fieldListContainsAll;
internal.getColumnType = getColumnType;
internal.deleteFields = deleteFields;
internal.isInvalidFieldName = isInvalidFieldName;
internal.getUniqFieldNames = getUniqFieldNames;
internal.getUniqFieldValues = getUniqFieldValues;
internal.applyFieldOrder = applyFieldOrder;
internal.findFieldNames = findFieldNames;
